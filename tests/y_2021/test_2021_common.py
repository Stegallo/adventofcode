...
from y_2021.common import AoCDay, load_input, main
...
def test_main():
    with contextlib.ExitStack() as patches:
        patches.enter_context(patch("y_2021.common.argparse"))
        patches.enter_context(patch("y_2021.common.open"))
        patches.enter_context(patch("y_2021.common.importlib"))
        assert main() is None
