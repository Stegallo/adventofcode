...
def test__preprocess_input():
    ...
    day._preprocess_input()
    assert day._Day__p1 == deque([43, 19])
    assert day._Day__p2 == deque([2, 29, 14])
...
def test__play_round():
    ...
    day._Day__play_round(day._Day__p1, day._Day__p2)
